<%@ Page Language="VB" MasterPageFile="~/RI.master" AutoEventWireup="false" CodeFile="CorrectiveActionItems.aspx.vb"
    Inherits="RI_RCFACorrectiveActionItems" Title="Untitled Page" EnableViewState="True"
  ...
  <!--
   ...
   -->
                ...
                <columns>
                   ...
                   <asp:TableRow>    
                    ...
                    <asp:TableCell colspan="2" VerticalAlign="top">
   				   ...
   				   <asp:TableCell rowspan="2" border="2" VerticalAlign="top">
                            <asp:Label ID="_lblRepeat" runat="server" Text='<%$ RIResources:Shared,Repeat Action %>'></asp:Label><br />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                                TargetControlID="_tbRepeatUnit" FilterType="custom" ValidChars="1234567890">
                            </ajaxToolkit:FilteredTextBoxExtender>
                            <asp:TextBox id="_tbRepeatUnit" runat="server" width="20pt" maxlength="3" text='<%# Container.DataItem("repeatunitsqty") %>' OnTextChanged="_gvCorrectiveActions.HandleRowChanged" /><br />
                            <asp:Label ID="_lblOften" runat="server" Text='<%$ RIResources:Shared,How Often?%>'></asp:Label><br />
   				    <asp:DropDownList id="_ddlRepeat" runat="server">
                        <asp:ListItem Value="" Text="" />
                        <asp:ListItem Value="Days" Text="<%$ RIResources:Shared,Days%>" />
                        <asp:ListItem Value="Weeks" Text="<%$ RIResources:Shared,Weeks%>" />
                        <asp:ListItem Value="Months" Text="<%$ RIResources:Shared,Months%>" />
                        <asp:ListItem Value="Years" Text="<%$ RIResources:Shared,Years%>" />
            ...
            <center>
                ...
                <%--<asp:Button ID="_btnSaveClose" runat="server" Text="<%$Resources:Shared,lblSaveCloseAI%>" />--%>
            </center>
