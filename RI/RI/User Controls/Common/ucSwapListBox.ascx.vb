...
Partial Class ucSwapList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.ClientScript.IsClientScriptIncludeRegistered(Page.GetType, "SwapListBox" & Me.ID) Then Page.ClientScript.RegisterClientScriptInclude(Page.GetType, "SwapListBox" & Me.ID, Page.ResolveClientUrl("~/ri/User Controls/Common/SwapListBox.js"))
