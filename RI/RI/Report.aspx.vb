    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If r IsNot Nothing Then
                ...
                Else
                    'Response.Write("../../CEReporting/" & ReportPage & "?Param=" & Replace(sb.ToString, " ", "%20"))
                    ...
                    RI.SharedFunctions.InsertAuditRecord("RIReport", RI.SharedFunctions.GetServerUrl() & "CEReporting/" & ReportPage & "?Param=" & Replace(sb.ToString, " ", "%20"))
