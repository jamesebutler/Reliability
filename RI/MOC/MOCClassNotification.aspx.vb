...
Partial Class MOC_Classification2
    Inherits RIBasePage
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        'Master.SetBanner("MOC Default Approvers")
    ...
    Protected Sub _gvL1Approvers_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles _gvL1Approvers.RowDeleting
        Dim strDeleteRecord As String = Me._gvL1Approvers.DataKeys.Item(e.RowIndex).Value

        DeleteBUA(strDeleteRecord)
    End Sub

    Protected Sub _gvL2Approvers_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles _gvL2Approvers.RowDeleting
        Dim strDeleteRecord As String = Me._gvL2Approvers.DataKeys.Item(e.RowIndex).Value

        DeleteBUA(strDeleteRecord)
    End Sub

    Protected Sub _gvL3Approvers_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles _gvL3Approvers.RowDeleting
        Dim strDeleteRecord As String = Me._gvL3Approvers.DataKeys.Item(e.RowIndex).Value
