<%@ Page Language="VB" MasterPageFile="~/RI.master" AutoEventWireup="false" CodeFile="DataMaintenance.aspx.vb" Inherits="OutageData_Maintenance" title="Outage:Data Maintenance" %>
    ...
    <br />
        <asp:Table ID="_tblOutageStatus" runat="server" CellPadding="2" CellSpacing="2" BackColor="white" Style="width: 50%" > 
            <asp:TableRow CssClass="Border">
                ...
                <center>
                    <asp:HyperLink ID="_hlResources" runat="server" NavigateUrl="~/Outage/DataMaintenance/additionalresources.aspx">Resources</asp:HyperLink>
                </center>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow CssClass="Border">
                <asp:TableCell CssClass="Border"> 
                <center>
                    <asp:HyperLink ID="_hlOutageTemplates" runat="server" NavigateUrl="~/Outage/DataMaintenance/manageoutagetemplates.aspx">Outage Templates</asp:HyperLink>
                </center>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
